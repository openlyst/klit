...
mixin _$Post {
 ...
 int get id; String? get file; String? get sample; String? get preview; int get width; int get height; String get ext; int get size; Map<String, String?>? get variants; Map<String, List<String>> get tags; int get uploaderId; String? get uploaderName; DateTime get createdAt; DateTime? get updatedAt; int? get changeSeq; int? get approverId; VoteInfo get vote; bool get isDeleted; Rating get rating; int get favCount; bool get isFavorited; int get commentCount; String get description; List<String> get sources; List<int>? get pools; List<String>? get lockedTags; Relationships get relationships;
...
@useResult
$Res call({
 int id, String? file, String? sample, String? preview, int width, int height, String ext, int size, Map<String, String?>? variants, Map<String, List<String>> tags, int uploaderId, String? uploaderName, DateTime createdAt, DateTime? updatedAt, int? changeSeq, int? approverId, VoteInfo vote, bool isDeleted, Rating rating, int favCount, bool isFavorited, int commentCount, String description, List<String> sources, List<int>? pools, List<String>? lockedTags, Relationships relationships
});
...
as int,uploaderName: freezed == uploaderName ? _self.uploaderName : uploaderName // ignore: cast_nullable_to_non_nullable
as String?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,changeSeq: freezed == changeSeq ? _self.changeSeq : changeSeq // ignore: cast_nullable_to_non_nullable
...
as List<int>?,lockedTags: freezed == lockedTags ? _self.lockedTags : lockedTags // ignore: cast_nullable_to_non_nullable
...
class _Post implements Post {
  const _Post({required this.id, required this.file, required this.sample, required this.preview, required this.width, required this.height, required this.ext, required this.size, required final  Map<String, String?>? variants, required final  Map<String, List<String>> tags, required this.uploaderId, this.uploaderName, required this.createdAt, required this.updatedAt, this.changeSeq, this.approverId, required this.vote, required this.isDeleted, required this.rating, required this.favCount, required this.isFavorited, required this.commentCount, required this.description, required final  List<String> sources, required final  List<int>? pools, final  List<String>? lockedTags, required this.relationships}): _variants = variants,_tags = tags,_sources = sources,_pools = pools,_lockedTags = lockedTags;
...
@override final  int? changeSeq;
@override final  int? approverId;
...
@override List<String>? get lockedTags {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Post&&(identical(other.id, id) || other.id == id)&&(identical(other.file, file) || other.file == file)&&(identical(other.sample, sample) || other.sample == sample)&&(identical(other.preview, preview) || other.preview == preview)&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.ext, ext) || other.ext == ext)&&(identical(other.size, size) || other.size == size)&&const DeepCollectionEquality().equals(other._variants, _variants)&&const DeepCollectionEquality().equals(other._tags, _tags)&&(identical(other.uploaderId, uploaderId) || other.uploaderId == uploaderId)&&(identical(other.uploaderName, uploaderName) || other.uploaderName == uploaderName)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.changeSeq, changeSeq) || other.changeSeq == changeSeq)&&(identical(other.approverId, approverId) || other.approverId == approverId)&&(identical(other.vote, vote) || other.vote == vote)&&(identical(other.isDeleted, isDeleted) || other.isDeleted == isDeleted)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.favCount, favCount) || other.favCount == favCount)&&(identical(other.isFavorited, isFavorited) || other.isFavorited == isFavorited)&&(identical(other.commentCount, commentCount) || other.commentCount == commentCount)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other._sources, _sources)&&const DeepCollectionEquality().equals(other._pools, _pools)&&const DeepCollectionEquality().equals(other._lockedTags, _lockedTags)&&(identical(other.relationships, relationships) || other.relationships == relationships));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,file,sample,preview,width,height,ext,size,const DeepCollectionEquality().hash(_variants),const DeepCollectionEquality().hash(_tags),uploaderId,uploaderName,createdAt,updatedAt,changeSeq,approverId,vote,isDeleted,rating,favCount,isFavorited,commentCount,description,const DeepCollectionEquality().hash(_sources),const DeepCollectionEquality().hash(_pools),const DeepCollectionEquality().hash(_lockedTags),relationships]);
...
as List<int>?,lockedTags: freezed == lockedTags ? _self._lockedTags : lockedTags // ignore: cast_nullable_to_non_nullable
as List<String>?,relationships: null == relationships ? _self.relationships : relationships // ignore: cast_nullable_to_non_nullable
as Relationships,
  ));
}
